...
> Status: Phase 1 ✅, Phase 1b ✅, Phase 2 ✅, Phase 2b ✅ (MCP server), Phase F0 ✅, Phase F1 ✅, Phase F2 ✅ (engram 側) — 次手: Phase F3（燃料オフ監査 + A/B 評価）
...
Phase F3 (監査/評価)  ← F2 に依存。次手。燃料の効果を定量判定するゲート
