...
> Date: 2026-03-13
> Status: Phase 1 完了、Phase 1b 実装中
...
Phase 1b (consensus)  ← Phase 1 の分類基盤に依存、実装中
Phase 2  (閲覧)       ← 独立、Phase 1 と並行可能
Phase 3  (engram)     ← Phase 2 の出力フォーマットに依存
Phase 4  (実験)       ← Phase 1/1b の制御基盤があると効率的
Phase 5  (LLM)        ← Phase 2 + Phase 4c の知見に依存
```
